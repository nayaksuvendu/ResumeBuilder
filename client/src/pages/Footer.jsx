...
const CurrentYear=date.getFullYear();
  return (
    ...
    <p className='flex'><i className='mt-1 mr-1'></i>Copyright &#169; {CurrentYear} | All rights reserved.Designed By <span className=' text-blue-500 ml-1 font-[Dancing Script]'>Suvendu Nayak</span></p>
    </section>
    <section className='flex items-center justify-center gap-5 text-2xl mr-5 '>
      ...
      <button id="telegram" class="bg-white  transform hover:-translate-y-3  border-2 w-7 h-7 rounded-full duration-500 text-blue-400 border-blue-400 hover:bg-blue-400 hover:text-white text-2xl">
       <i class="fab fa-telegram-plane"><BiLogoTwitter/></i>
      </button>
    </section>         
    </footer>
   </>

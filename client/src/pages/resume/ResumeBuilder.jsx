...
import Template3 from "../../assets/image/Template3.png";
import Template4 from "../../assets/image/Template4.png";
import Template5 from "../../assets/image/Template5.png";
import Template6 from "../../assets/image/Template6.png";
import Template7 from "../../assets/image/Template7.png";
...
const ColorlibStepIconRoot = styled("div")(({ theme, ownerState }) => ({
  ...
  alignItems: "center",
  ...(ownerState.active && {
    backgroundImage: "linear-gradient(140deg,#BE1DFF,#E91DFF)",
...
export default function ResumeBuilder() {
  ...
  const [titleColor, setTitleColor] = React.useState("#7c3aed");
  ...
  return (
     <HomeLayout>
       <ThemeProvider theme={themeColor}>
        ...
        <Box sx={{ width: "100%", padding: "30px 50px" }}>
          ...
          <Box style={{ textAlign: "right" }}>
            <label htmlFor="each-title-color">
              ...
              >
                <span className=" text-purple-600 text-sm">Title Color</span>
              </Button>
            </label>
            <Button
              ...
              sx={{ marginLeft: "10px" }}
            >
             <span className=" text-purple-600 text-sm ">Template Options</span> 
            </Button>
            <Modal

...
import { getUserProfile, updateUser } from '../../Redux/Slices/UserAuth';
...
export default function EditProfile() {
    ...
    async function onFormSubmit(e){
        ...
        if(updateData.fullname.length < 5) {
            toast.error("Name can't be of less than 5 characters");
            return;
        }
  ...
  return (
    <HomeLayout>
        <div className='flex justify-center items-center h-[90vh]'>
            <form 
            noValidate
            className='flex flex-col justify-center gap-5 rou p-4  w-96 min-h-[26rem] shadow-[0_0_10px_black]'
            onSubmit={onFormSubmit}
            >
                <h1 className=' text-center text-3xl font-bold border-b-2 border-black'>Edit Profile</h1>
                ...
                <button
                type='submit'
                className='w-full text-white bg-purple-600 hover:bg-purple-700 transition-all ease-in-out duration-300
